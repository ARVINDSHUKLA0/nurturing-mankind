...
export default function Navbar({ hasBanner }) { 
                ...
                <ul className="d-md-flex d-block align-items-xl-center  gap-3 m-0 p-0">
                  ...
                  <li className="list-style-none position-relative dropdown-parent">
                    ...
                    <ul className={`dropdown-wrapper p-0 ${openSubMenu === 'about' ? 'submenu-open' : ''}`}>
                      <li className="list-style-none py-2 dropdown-bottom-border"><Link href="/Introduction" onClick={closeAllMenus} className="text-decoration-none text-white text-uppercase fs-10">Introduction</Link></li>
                      <li className="list-style-none py-2 dropdown-bottom-border"><Link href="/Vision" onClick={closeAllMenus} className="text-decoration-none text-white text-uppercase fs-10">Vision</Link></li>
                      <li className="list-style-none py-2 dropdown-bottom-border"><Link href="/Mission" onClick={closeAllMenus} className="text-decoration-none text-white text-uppercase fs-10">Mission</Link></li>
                      <li className="list-style-none py-2 dropdown-bottom-border"><Link href="/Governing" onClick={closeAllMenus} className="text-decoration-none text-white text-uppercase fs-10">Governing Body</Link></li>
                    </ul>
                  </li>
                  ...
                  <li className="list-style-none position-relative dropdown-parent">
                    ...
                    <ul className={`dropdown-wrapper p-0 ${openSubMenu === 'works' ? 'submenu-open' : ''}`}>
                      <li className="list-style-none py-2 dropdown-bottom-border"><Link href="/AnimalWelfa" onClick={closeAllMenus} className="text-decoration-none text-white text-uppercase fs-10">Animal Welfare</Link></li>
                      <li className="list-style-none py-2 dropdown-bottom-border"><Link href="/Livelihood" onClick={closeAllMenus} className="text-decoration-none text-white text-uppercase fs-10">Livelihood</Link></li>
                    </ul>
                  </li>
                  ...
                  <li className="list-style-none position-relative dropdown-parent">
                    ...
                    <ul className={`dropdown-wrapper p-0 ${openSubMenu === 'campaigns' ? 'submenu-open' : ''}`}>
                      <li className="list-style-none py-2 dropdown-bottom-border"><Link href="/DogRabies" onClick={closeAllMenus} className="text-decoration-none text-white text-uppercase fs-10">Eradicating Dog Mediated Rabies by 2030</Link></li>
                      <li className="list-style-none py-2 dropdown-bottom-border"><Link href="/DoghitRun" onClick={closeAllMenus} className="text-decoration-none text-white text-uppercase fs-10">Reducing Stray Dog Hit & Run Road Fatalities</Link></li>
                      <li className="list-style-none py-2 dropdown-bottom-border"><Link href="/DogVaccinating" onClick={closeAllMenus} className="text-decoration-none text-white text-uppercase fs-10">Vaccinating Stray Dogs against life threatnening diseases</Link></li>
                    </ul>
                  </li>

                  <li className="list-style-none position-relative dropdown-parent">
                    <div className="d-flex align-items-center justify-content-between">
                      <span className="text-decoration-none custom-all-color-white text-uppercase fs-12 py-lg-4 py-2 mt-1">support</span>
                      <i
                    ...
                    <ul className={`dropdown-wrapper p-0 ${openSubMenu === 'volunteer' ? 'submenu-open' : ''}`}>
                      <li className="list-style-none py-2 dropdown-bottom-border"><Link href="/Sponsor" onClick={closeAllMenus} className="text-decoration-none text-white text-uppercase fs-10">Sponsor</Link></li>
